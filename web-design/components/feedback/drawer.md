...
> Category: **Feedback**  
> Identifier: `drawer`  
> Definition: Slide-over panel anchored to the edge of the screen.
...
### Core Purpose
Slide-over panel anchored to the edge of the screen.

### When to Use
Use for viewing details, creating complex sub-entities, or filtering data without losing main page context.

### When NOT to Use
Do not use for simple 1-click confirmation dialogs; use Popconfirm instead. Consult the [Component Decision Tree](../../references/component-decision-tree.md) for alternatives.
...
```text
Drawer Structural Hierarchy:
├── Mask: Semi-transparent backdrop.
├── Panel: Sliding elevated card.
...
- **Right side**: Right side (standard)
- **Left / Top / Bottom slide-overs**: Left / Top / Bottom slide-overs
- **With or without backdrop mask**: With or without backdrop mask
...
- **Key Attributes**: `aria-modal="true"`, `aria-labelledby="drawer_title_id"`
- **Keyboard Navigation**: Traps focus while open; Escape dismisses drawer and returns focus to trigger.
