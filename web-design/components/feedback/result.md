...
> Category: **Feedback**  
> Identifier: `result`  
> Definition: Full-page feedback view announcing task outcomes or route exceptions.
...
### Core Purpose
Full-page feedback view announcing task outcomes or route exceptions.

### When to Use
Use after completing complex workflows (payment success, application submitted) or for error routes (403, 404, 500).

### When NOT to Use
Do not use for transient inline micro-actions; use Message instead. Consult the [Component Decision Tree](../../references/component-decision-tree.md) for alternatives.
...
```text
Result Structural Hierarchy:
├── Root: Centered page container.
├── Icon: Large status illustration.
├── Title: Bold outcome headline.
├── SubTitle: Descriptive text.
├── Extra: Primary and secondary action buttons.
```
...
- **Error**: Error (red cross)
- **Warning**: Warning (amber alert)
- **403 / 404 / 500 exceptions**: 403 / 404 / 500 exceptions
...
- **Key Attributes**: `aria-label="Result status"`
- **Keyboard Navigation**: Announces workflow outcome.
