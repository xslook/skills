...
> Category: **Other**  
> Identifier: `border-beam`  
> Definition: Animated glowing border highlight for drawing attention to featured containers.
...
### Core Purpose
Animated glowing border highlight for drawing attention to featured containers.

### When to Use
Use for promotional cards, featured pricing tiers, or active AI processing frames.

### When NOT to Use
Do not use on everyday data inputs or standard form cards. Consult the [Component Decision Tree](../../references/component-decision-tree.md) for alternatives.
...
```text
BorderBeam Structural Hierarchy:
├── Root: Absolute overlay positioned along container borders with animated CSS clip/offset.
```
...
- **Linear gradient beam**: Linear gradient beam
- **Customizable speed, color, and size**: Customizable speed, color, and size
...
- **Keyboard Navigation**: Visual animation hidden from screen readers.
