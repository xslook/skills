...
> Category: **Layout**  
> Identifier: `masonry`  
> Definition: Waterfall grid layout with dynamic item heights.
...
### Core Purpose
Waterfall grid layout with dynamic item heights.

### When to Use
Use for visual media cards, dashboards with irregular card heights, or image galleries.

### When NOT to Use
Do not use for uniform structured data tables or sequential forms. Consult the [Component Decision Tree](../../references/component-decision-tree.md) for alternatives.
...
```text
Masonry Structural Hierarchy:
├── Root: Multi-column container.
├── Column: Vertical column stack.
...
- **Multi-column fluid**: Multi-column fluid
- **Dynamic height stacking**: Dynamic height stacking
...
- **Key Attributes**: `aria-label="Masonry container"`
- **Keyboard Navigation**: Tab navigates through children sequentially.
