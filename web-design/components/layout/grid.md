...
> Category: **Layout**  
> Identifier: `grid`  
> Definition: 24-column responsive grid layout based on Row and Col.
...
### Core Purpose
24-column responsive grid layout based on Row and Col.

### When to Use
Use to partition content into proportional columns (1/2, 1/3, 1/4, 1/6) with responsive breakpoint adaptation.

### When NOT to Use
Do not use for simple inline item spacing; use Space or Flex instead. Consult the [Component Decision Tree](../../references/component-decision-tree.md) for alternatives.
...
```text
Grid Structural Hierarchy:
├── Row: Flex grid container defining negative margins for gutters.
├── Col: Grid column defining span percentage and interior gutter padding.
```
...
- **Basic**: Basic (spans 1 to 24)
- **Gutter**: Gutter (fixed horizontal and vertical spacing)
- **Offset**: Offset (offsetting columns)
- **Responsive**: Responsive (xs, sm, md, lg, xl, xxl overrides)
...
- **Key Attributes**: Semantic tags
- **Keyboard Navigation**: Standard DOM tab order.
